    ...
    return (
      ...
      <img
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
            <h1 className="text-3xl text-center font-bold text-white bg-black opacity-50">PUBG MOBILE</h1>
      ...
      <img
          ...
          className="w-full h-96 bg-cover bg-no-repeat bg-center" />
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
            <h1 className="text-3xl text-center font-bold text-white opacity-50">Explore The Game Of Battle</h1>
      ...
      <img
          ...
          className="w-full h-96 bg-cover bg-no-repeat bg-center" />
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
            <h1 className="text-3xl text-center font-bold text-white">eFootball</h1>
      ...
      <img
          ...
          className="w-full h-96 bg-cover bg-no-repeat bg-center" />
         <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
            <h1 className="text-3xl text-center font-bold text-white bg-black opacity-50">Prince Of Persia</h1>
